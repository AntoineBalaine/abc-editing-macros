...
const transposeOctUp = (input) => {
    ...
    return (0, dispatcher_1.noteDispatcher)({
        text: input,
        context,
        transformFunction: transformPitches_1.octaviateUpTransform,
    });
};
...
const transposeOctDown = (input) => {
    ...
    return (0, dispatcher_1.noteDispatcher)({
        text: input,
        context,
        transformFunction: transformPitches_1.octaviateDownTransform,
    });
};
...
const transposeHalfStepUp = (input) => {
    ...
    return (0, dispatcher_1.noteDispatcher)({
        text: input,
        context,
        transformFunction: transformPitches_1.transposeHalfStepUpTransform,
    });
};
...
const transposeHalfStepDown = (input) => {
    ...
    return (0, dispatcher_1.noteDispatcher)({
        text: input,
        context,
        transformFunction: transformPitches_1.transposeHalfStepDownTransform,
    });
};
