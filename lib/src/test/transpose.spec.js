    ...
    describe("using dispatcher function", function () {
        ...
        it("1 step up", function () {
            assert_1.default.equal((0, dispatcher_1.noteDispatcher)({
                text: "C,E,_G,B,,_e",
                context: { pos: 0 },
                transformFunction: transformPitches_1.transposeStepUpTransform,
            }), "D,^F,^G,^C,f");
            assert_1.default.equal((0, dispatcher_1.noteDispatcher)({
                text: "C,E,G,B,,e",
                context: { pos: 0 },
                transformFunction: (note) => (0, transformPitches_1.transposeStepUpTransform)(note, "[K:A]"),
            }), "D,^F,A,^C,^f");
        });
        it("1 step down", function () {
            assert_1.default.equal((0, dispatcher_1.noteDispatcher)({
                text: "C,E,^F,B,,_e",
                context: { pos: 0 },
                transformFunction: transformPitches_1.transposeStepDownTransform,
            }), "_B,D,E,A,_d");
            assert_1.default.equal((0, dispatcher_1.noteDispatcher)({
                text: "^C,E,G,B,,e",
                context: { pos: 0 },
                transformFunction: (note) => (0, transformPitches_1.transposeStepDownTransform)(note, "[K:A]"),
            }), "B,D,^E,A,d");
        });
...
describe("Nomenclature", function () {
    ...
    describe("using detector function", function () {
        ...
        it("leave symbols untouched", function () {
            ...
            assert_1.default.equal((0, parseNomenclature_1.jumpToEndOfSymbol)({
                text: symbol,
                context: { pos: 0 },
                transformFunction: () => "",
                dispatcherFunction: dispatcher_1.noteDispatcher,
            }), symbol);
        });
    ...
    describe("using dispatcher function", function () {
        it("recognizes line comments", function () {
            ...
            assert_1.default.notEqual((0, dispatcher_1.noteDispatcher)({
                text: notNomenclature,
                context: { pos: 0 },
                transformFunction: () => "",
                tag: "",
            }), notNomenclature);
