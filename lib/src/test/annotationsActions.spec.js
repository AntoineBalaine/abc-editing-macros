...
const consolidateRestsInRoutineSamples_1 = require("./consolidateRestsInRoutineSamples");
    ...
    describe("using annotations in score", function () {
        it("strips annotations of any instrument references", function () {
            ...
            assert_1.default.equal((0, dispatcher_1.noteDispatcher)({
                ...
                context: { pos: 0 },
                transformFunction: () => "",
                tag: annotationsActions_1.instrumentFamilies.strings,
            }), '"soli"A,B,CDEFG');
        });
...
%`;
    ...
    describe("consolidates rests in routine", function () {
        const { singleBar, singleBarContainingChords, singleBarContainingChordsAndAnnotations, singleBarContainingChordsAnnotationsSymbols, singleBarContainingChordsAnnotationsSymbolsNomenclature, multipleBarsContainingChordsAnnotationsSymbolsNomenclature, multipleBarsContainingChordsAnnotationsSymbolsNomenclatureLineBreaks, } = consolidateRestsInRoutineSamples_1.restsInRoutineSamples;
        const { consolidatedSingleBar, consolidatedSingleBarContainingChords, consolidatedSingleBarContainingChordsAndAnnotations, consolidatedSingleBarContainingChordsAnnotationsSymbols, consolidatedSingleBarContainingChordsAnnotationsSymbolsNomenclature, consolidatedMultipleBarsContainingChordsAnnotationsSymbolsNomenclature, consolidatedMultipleBarsContainingChordsAnnotationsSymbolsNomenclatureLineBreaks, } = consolidateRestsInRoutineSamples_1.consolidatedRestsInRoutine;
        it("consolidates consecutive rests body of tune", function () {
            assert_1.default.equal((0, annotationsActions_1.consolidateRestsInRoutine)(singleBar), consolidatedSingleBar);
            assert_1.default.equal((0, annotationsActions_1.consolidateRestsInRoutine)(singleBarContainingChords), consolidatedSingleBarContainingChords);
            assert_1.default.equal((0, annotationsActions_1.consolidateRestsInRoutine)(singleBarContainingChordsAndAnnotations), consolidatedSingleBarContainingChordsAndAnnotations);
            assert_1.default.equal((0, annotationsActions_1.consolidateRestsInRoutine)(singleBarContainingChordsAnnotationsSymbols), consolidatedSingleBarContainingChordsAnnotationsSymbols);
            assert_1.default.equal((0, annotationsActions_1.consolidateRestsInRoutine)(singleBarContainingChordsAnnotationsSymbolsNomenclature), consolidatedSingleBarContainingChordsAnnotationsSymbolsNomenclature);
            assert_1.default.equal((0, annotationsActions_1.consolidateRestsInRoutine)(multipleBarsContainingChordsAnnotationsSymbolsNomenclature), consolidatedMultipleBarsContainingChordsAnnotationsSymbolsNomenclature);
            assert_1.default.equal((0, annotationsActions_1.consolidateRestsInRoutine)(multipleBarsContainingChordsAnnotationsSymbolsNomenclatureLineBreaks), consolidatedMultipleBarsContainingChordsAnnotationsSymbolsNomenclatureLineBreaks);
        });
    });
});
