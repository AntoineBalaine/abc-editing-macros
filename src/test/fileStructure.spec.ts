...
const treatedScoreFilePath =
  "src/test/test_out/BachCelloSuiteDmin.InstrumentFamilies.test.abc";
...
V: str name="str"`;
  ...
  it("meshes multiple-line ensemble score into score-systems", async function () {
    const testBody = separateHeaderAndBody(treatedTestScore as abcText, {
      pos: 0,
    }).bodyText;
