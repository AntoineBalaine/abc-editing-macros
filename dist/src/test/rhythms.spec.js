...
describe("Rhythms", function () {
    ...
    describe("using dispatcher", function () {
        //todo, account for broken rhythms
        it("duplicates note's length", function () {
            assert_1.default.equal((0, dispatcher_1.dispatcher)("a/2", { pos: 0 }, transformRests_1.duplicateLengthTransform), "a");
        });
        it("divides note's length", function () {
            assert_1.default.equal((0, dispatcher_1.dispatcher)("a", { pos: 0 }, transformRests_1.divideLengthTransform), "a/");
        });
        it("duplicates and divides broken rhythms", function () {
            assert_1.default.equal((0, dispatcher_1.dispatcher)("a/2>a/2", { pos: 0 }, transformRests_1.duplicateLengthTransform), "a>a");
            assert_1.default.equal((0, dispatcher_1.dispatcher)("a>a", { pos: 0 }, transformRests_1.divideLengthTransform), "a/>a/");
        });
    });
});
